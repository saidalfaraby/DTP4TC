...
#ifndef lint
static char rcsid[] DD_UNUSED = "$Id: cuddLinear.c,v 2.0 2003/02/07 00:12:35 staubin Exp $";
#endif
...
int cuddLinearInPlace ARGS((DdManager *table, int x, int y));
static void ddUpdateInteractionMatrix ARGS((DdManager *table, int xindex, int yindex));
int cuddInitLinear ARGS((DdManager *table));
int cuddResizeLinear ARGS((DdManager *table));
