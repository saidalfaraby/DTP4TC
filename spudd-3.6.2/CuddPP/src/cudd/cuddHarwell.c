...
#ifndef lint
static char rcsid[] DD_UNUSED = "$Id: cuddHarwell.c,v 2.0 2003/02/07 00:12:34 staubin Exp $";
#endif
  ...
  int  pr /* verbosity level */)
{
    ...
    *E = zero; cuddRef(*E);
	...
	for (i=colptr[j]; i<colptr[j+1]; i++) {
	    ...
	    Terminal valTerminal;
	    valTerminal.set((double) val);
	    cubex = cuddUniqueConst(dd,&valTerminal);
