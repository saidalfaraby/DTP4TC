...
EXTERN int Dddmp_cuddAddStore(DdManager *dd, char *ddname, DdNode *f, char **varnames, int *auxids, int mode, Dddmp_VarInfoType varinfo, char *fname, FILE *fp);
EXTERN int Dddmp_cuddAddArrayStore(DdManager *dd, char *ddname, int nroots, DdNode **f, char **rootnames, char **varnames, int *auxids, int mode, Dddmp_VarInfoType varinfo, char *fname, FILE *fp);
...
EXTERN DdNode * Dddmp_cuddAddLoad(DdManager *dd, Dddmp_VarMatchType varmatchmode, char **varmatchnames, int *varmatchauxids, int *varcomposeids, int mode, char *file, FILE *fp);
EXTERN int Dddmp_cuddAddArrayLoad(DdManager *dd, Dddmp_RootMatchType rootmatchmode, char **rootmatchnames, Dddmp_VarMatchType varmatchmode, char **varmatchnames, int *varmatchauxids, int *varcomposeids, int mode, char *file, FILE *fp, DdNode ***pproots);
