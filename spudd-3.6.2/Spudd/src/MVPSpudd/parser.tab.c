...
{
       0,     0,     3,     5,    11,    16,    18,    21,    26,    28,
      31,    34,    37,    39,    41,    46,    49,    50,    52,    55,
      57,    58,    62,    63,    69,    70,    76,    77,    83,    87,
      90,    92,    95,    97,    98,   104,   107,   109,   111,   112,
     116,   119,   121,   123,   126
};
...
{
      22,     0,    -1,    23,    -1,    24,    29,    47,    49,    50,
      -1,     6,     8,    25,     7,    -1,    26,    -1,    25,    26,
      -1,     6,    27,    28,     7,    -1,     3,    -1,    28,     3,
      -1,     3,     3,    -1,    29,    30,    -1,    30,    -1,    31,
      -1,    32,    33,    34,    14,    -1,    13,     3,    -1,    -1,
       4,    -1,    34,    35,    -1,    35,    -1,    -1,     3,    36,
      37,    -1,    -1,    17,    16,    38,    41,    18,    -1,    -1,
      17,    15,    39,    41,    18,    -1,    -1,     6,     3,    40,
      42,     7,    -1,     6,    45,     7,    -1,    41,    37,    -1,
      37,    -1,    42,    43,    -1,    43,    -1,    -1,     6,     3,
      44,    37,     7,    -1,    45,    46,    -1,    46,    -1,     4,
      -1,    -1,    11,    48,    37,    -1,     9,     4,    -1,    51,
      -1,    52,    -1,    10,     4,    -1,    19,     4,    -1
};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint16 yyrline[] =
{
       0,    48,    48,    51,    54,    71,    71,    74,    80,    85,
      87,    93,    93,    96,   102,   108,   114,   117,   122,   122,
     125,   125,   150,   150,   157,   157,   164,   164,   187,   207,
     219,   226,   232,   244,   244,   261,   267,   274,   293,   293,
     302,   306,   306,   309,   315
};
#endif
...
static const char *const yytname[] =
{
  ...
  "ENDACTION", "DISJ", "CONJ", "OSB", "CSB", "HORIZON", "VAL", "$accept",
  "input", "mdp", "varilist", "varlist", "vardec", "varname", "vallist",
  "actslist", "action", "simpleaction", "actionname", "actioncost",
  "acttreelist", "acttree", "$@1", "theadd", "$@2", "$@3", "$@4",
  "con_dis_add", "currentadd", "subadd", "$@5", "primeadd", "constadd",
  "reward", "$@6", "disc", "tolhor", "tol", "hor", YY_NULL
};
#endif
...
static const yytype_uint8 yyr1[] =
{
      ...
      36,    35,    38,    37,    39,    37,    40,    37,    37,    41,
      41,    42,    42,    44,    43,    45,    45,    46,    48,    47,
      49,    50,    50,    51,    52
};
...
{
       0,     0,     0,     2,     0,     0,     1,     0,     0,    12,
      13,    16,     0,     0,     5,    15,    38,    11,     0,    17,
       0,     8,     0,     4,     6,     0,     0,     0,    20,     0,
      19,     0,     0,     0,     0,    39,    40,     0,     0,     3,
      41,    42,     0,    14,    18,    10,     9,     7,    26,    37,
       0,    36,    24,    22,    43,    44,    21,     0,    28,    35,
       0,     0,     0,     0,    32,    30,     0,     0,    33,    27,
      31,    25,    29,    23,     0,     0,    34
};
...
{
      -1,     2,     3,     4,    13,    14,    22,    32,     8,     9,
      10,    11,    20,    29,    30,    42,    65,    61,    60,    57,
      66,    63,    64,    74,    50,    51,    18,    25,    27,    39,
      40,    41
};
...
{
      14,    23,    10,   -26,    17,    26,   -26,    30,     8,   -26,
     -26,    31,    33,    16,   -26,   -26,   -26,   -26,    25,   -26,
      34,   -26,    35,   -26,   -26,    -1,    36,    -8,   -26,     4,
     -26,    40,     1,    21,    11,   -26,   -26,    41,    42,   -26,
     -26,   -26,    -1,   -26,   -26,   -26,   -26,   -26,   -26,   -26,
       2,   -26,   -26,   -26,   -26,   -26,   -26,    38,   -26,   -26,
      -1,    -1,    44,    22,   -26,   -26,    -5,    -3,   -26,   -26,
     -26,   -26,   -26,   -26,    -1,    32,   -26
};
...
{
     -26,   -26,   -26,   -26,   -26,    37,   -26,   -26,   -26,    43,
     -26,   -26,   -26,   -26,    19,   -26,   -25,   -26,   -26,   -26,
      -9,   -26,   -10,   -26,   -26,     5,   -26,   -26,   -26,   -26,
     -26,   -26
};
...
{
      35,    33,    37,    33,    46,    33,    49,    28,    47,    58,
       6,    38,    34,    71,    34,    73,    34,    56,    43,    16,
       1,     7,    12,    23,    48,    49,    52,    53,    62,    69,
       7,     5,    12,    15,    26,    19,    21,    28,    31,    76,
      36,    72,    72,    45,    62,    54,    55,    68,    44,    75,
      24,    17,    67,    70,     0,    59
};
...
{
      25,     6,    10,     6,     3,     6,     4,     3,     7,     7,
       0,    19,    17,    18,    17,    18,    17,    42,    14,    11,
       6,    13,     6,     7,     3,     4,    15,    16,     6,     7,
      13,     8,     6,     3,     9,     4,     3,     3,     3,     7,
       4,    66,    67,     3,     6,     4,     4,     3,    29,    74,
      13,     8,    61,    63,    -1,    50
};
...
{
       0,     6,    22,    23,    24,     8,     0,    13,    29,    30,
      31,    32,     6,    25,    26,     3,    11,    30,    47,     4,
      33,     3,    27,     7,    26,    48,     9,    49,     3,    34,
      35,     3,    28,     6,    17,    37,     4,    10,    19,    50,
      51,    52,    36,    14,    35,     3,     3,     7,     3,     4,
      45,    46,    15,    16,     4,     4,    37,    40,     7,    46,
      39,    38,     6,    42,    43,    37,    41,    41,     3,     7,
      43,    18,    37,    18,    44,    37,     7
};
...
#line 80 "parser.y"
    { 
  orig_vars[numorigvars].name = strdup((yyvsp[(1) - (1)].nme));
}
    break;
...
#line 85 "parser.y"
    { 
  addVar(orig_vars,numorigvars,(yyvsp[(2) - (2)].nme));
}
    break;
...
#line 87 "parser.y"
    { 
  addVar(orig_vars,numorigvars,(yyvsp[(1) - (2)].nme));
  addVar(orig_vars,numorigvars,(yyvsp[(2) - (2)].nme));
}
    break;
...
#line 108 "parser.y"
  ...
  actionlist[numactions].name = strdup((yyvsp[(2) - (2)].nme));
}
    break;
...
#line 117 "parser.y"
    {
  setActionCost(numactions,(yyvsp[(1) - (1)].val));
}
    break;
...
#line 125 "parser.y"
  ...
  if ((curr_primed_ovar = findOVar((yyvsp[(1) - (1)].nme))) < 0) {
...
#line 136 "parser.y"
  ...
  NewPrime[numactions][curr_primed_ovar] = (yyvsp[(3) - (3)].dnode);
...
#line 164 "parser.y"
  ...
  if ((curr_ovar = findOVar((yyvsp[(2) - (2)].nme))) < 0) 
...
#line 172 "parser.y"
  ...
  if ((curr_ovar = findOVar((yyvsp[(2) - (5)].nme))) < 0) 
...
#line 247 "parser.y"
  ...
  if ((curr_oval = findOVal(levelIndex[level],(yyvsp[(2) - (5)].nme))) < 0) {
    fprintf(stderr,"could not find value %s in variable %s action %s\n",
	    (yyvsp[(2) - (5)].nme),orig_vars[levelIndex[level]].name,actionlist[numactions].name);
    exit(-1);
  }
  (yyval.dnode) = buildCubeCPT(vars,curr_oval,orig_vars[levelIndex[level]],(yyvsp[(4) - (5)].dnode));
  Cudd_RecursiveDeref(gbm,(yyvsp[(4) - (5)].dnode));
  branchCount[level]++;
}
    break;
...
#line 274 "parser.y"
  ...
  if (!doing_reward) {
    ...
    (yyval.dnode) = buildCubeCPT(prime_vars,pvindex,orig_vars[curr_primed_ovar],temp);
