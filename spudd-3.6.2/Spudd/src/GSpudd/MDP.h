...
DdNode * My_cuddAddApplyRecur(DdManager *dd, DdNode * (*op)(DdManager *, DdNode **, DdNode **), DdNode * , DdNode * );
DdNode *My_addApply(DdManager *dd, DdNode * (*op)(DdManager *, DdNode **, DdNode **), DdNode * , DdNode * );
...
void printDdNode(DdManager *dd, DdNode **add, int numdds, rnum *vars, rnum *pvars, int numvars, onum *orig_vars, int numorigvars, FILE *fp, char *addprefix="ADD");
...
extern MixGauss tempOne,tempTwo;
extern double tolerance;
extern MixGauss *pZero, *pOne;
...
class MDP {
 protected:
  ...
  void allMixGausssApprox(DdNode **theADD);
 ...
 double simulater(int *state, int actionTaken, int *newstate, int *exclude=NULL);
  ...
  void getVal(DdManager *dd, DdNode *val, MixGauss & rval, int *varvals, bool primedvars=false);
  void getVal(DdManager *dd, DdNode *val, MixGauss & rval, int *varvals, int *varvalsp);
  ...
  DdNode *sumOutAllPrimedOrigVars(DdNode *dd);
  ...
  void writeCPTRaw(char *fileprefix);
  

  DdNode *sumOutOnePrime(DdNode *dd, int j);
