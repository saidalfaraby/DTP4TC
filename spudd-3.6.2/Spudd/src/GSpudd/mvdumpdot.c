...
void printDdNode(DdManager *dd, DdNode **add, int numdds, rnum *vars, rnum *pvars, int numvars, onum *orig_vars, int numorigvars, FILE *fp, char *addprefix)
{
  int i,j;
  int numexpadds = 40000;
  int numadds = 0;
